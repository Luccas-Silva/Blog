...
function Pagination({ totalPages, currentPage }: PaginationProps) {
  ...
  return (
    <div className="space-y-2 pt-6 pb-8 text-lg md:space-y-5">
      ...
      <div className="divide-primary-300 dark:divide-primary-300 divide-y-2">
        <div className="space-y-2 pt-6 pb-8 md:space-y-5">
          ...
          <div className="relative max-w-lg">
            ...
            <svg
              className="absolute top-3 right-3 h-5 w-5 text-gray-500 dark:text-gray-300"
        ...
        <ul divide-primary-300 dark:divide-primary-300 divide-y>
